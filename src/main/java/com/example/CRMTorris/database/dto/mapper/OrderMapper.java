...
public class OrderMapper extends AbstractMapper<Order, OrderDto> {
    ...
    public void setMapper() {
        mapper.createTypeMap(Order.class, OrderDto.class)
                .addMappings(m -> m.skip(OrderDto::setWorkerId)).setPostConverter(toDtoConverter());
        mapper.createTypeMap(Order.class, OrderDto.class)
                .addMappings(m -> m.skip(OrderDto::setManagerId)).setPostConverter(toDtoConverter());
        mapper.createTypeMap(Order.class, OrderDto.class)
                .addMappings(m -> m.skip(OrderDto::setInvoiceId)).setPostConverter(toDtoConverter());
        mapper.createTypeMap(OrderDto.class, Order.class)
                .addMappings(m -> m.skip(Order::setWorker)).setPostConverter(toEntityConverter());
        mapper.createTypeMap(OrderDto.class, Order.class)
                .addMappings(m -> m.skip(Order::setManager)).setPostConverter(toEntityConverter());
        mapper.createTypeMap(OrderDto.class, Order.class)
                .addMappings(m -> m.skip(Order::setInvoice)).setPostConverter(toEntityConverter());
    }
